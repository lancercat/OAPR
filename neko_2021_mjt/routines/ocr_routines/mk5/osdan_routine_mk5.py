...
from neko_sdk.MJT.neko_abstract_routines import neko_abstract_routine, neko_abstract_eval_routine;
...
class neko_HDOS2C_routine_CFmk5(neko_abstract_routine):
    ...
    def fp_impl(this, input_dict, modular_dict, logger_dict, nEpoch, batch_idx, device):
        ...
        out_emb,A=this.fe_seq(clips.to(device),modular_dict,length)
        # net forward
