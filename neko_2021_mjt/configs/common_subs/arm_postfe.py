...
from neko_2021_mjt.configs.modules.config_dtd_xos_mk5 import config_dtdmk5, config_dtdmk5d
...
def arm_rest_commonwops(srcdst,prefix,wemb=0.3,wrej=0.1,drop_DTD=False):
    if(drop_DTD):
