...
class neko_abstract_eval_routine:
    ...
    def perf_impl(this,idict,mdict,logger_dict):
        return this.test_impl(idict,mdict,logger_dict)
    def test(this,input_dict,modular_dict,override=None,vdbg=None):
        ...
        if(override is not None):
            for i in override:
                mdict[i]=modular_dict[i];
        if(vdbg is None):
            return this.perf_impl(idict,mdict,this.logger_dict);
        else:
            return this.test_impl(input_dict,mdict,this.logger_dict)
