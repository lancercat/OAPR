...
from neko_2022_soai_zero.project_aas_mk3_lsct.configs.data_cfg_lsct_AL import get_oss_training_protocolAL48_lsct
from neko_2022_soai_zero.project_aas_mk3_lsct.configs.loadouts.aas_mk3_lsct_ss import \
...
def dan_single_model_train_cfg(save_root,dsroot,
    ...
    maxT_chs=30;
    maxT_mjst=25;
    train_joint_ds,tr_meta_path_chs,maxT_chs,task_dict=get_oss_training_protocolAL48_lsct(dsroot,tag="base_chs_",log_path=log_path)
    ...
    routines = arm_aas_routine(routines, "base_chs_", osdanmk7g3APD_rec_ocr_routine, maxT_chs, log_path,
                               log_each, "dan_chs_",delay_till=-1);
