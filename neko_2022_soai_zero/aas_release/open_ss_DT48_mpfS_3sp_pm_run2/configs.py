...
from neko_2022_soai_zero.aas_release.configs.loadouts.aas_mk3_lsct_ss import \
    arm_module_set_r45trinorm_orig_dsa3hGTAnp_mk7g2_mpfS_3sp_pm_dtc32
...
def model_mod_cfg(tr_meta_path_chs,tr_meta_path_mjst,maxT_mjst,maxT_chs):
    ...
    feat_ch=512;
    mods={};
    mods=arm_module_set_r45trinorm_orig_dsa3hGTAnp_mk7g2_mpfS_3sp_pm_dtc32(mods,"base_chs_",maxT_chs,capacity,feat_ch,tr_meta_path_chs,wemb=0);
    return mods;
