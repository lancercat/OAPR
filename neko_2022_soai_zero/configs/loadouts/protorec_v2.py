...
from neko_2022_soai_zero.configs.loadouts.base_model import arm_base_module_setS
from neko_2022_soai_zero.configs.loadouts.base_model import arm_base_module_setXL, arm_base_module_setXLIN
from neko_2022_soai_zero.configs.loadouts.domd import arm_dom_mix_slacky, arm_dom_mix_slacky_mva, arm_dom_mix_mva
from neko_2022_soai_zero.configs.loadouts.individual_recs import arm_protorec_v2S, arm_protorec_v2, \
    arm_v2_shufDPS, arm_v2_shufADPS, arm_shuf_partsim, arm_v2_shuf, arm_v2_shufDP, arm_v2_shufSPS, arm_v2_shuf_link, \
    arm_v2_shufS, \
    arm_fpmrecS_v2, arm_fpmrec_v2
from neko_2022_soai_zero.configs.loadouts.protorec_cyc import arm_cycNS, arm_cycNSsp, arm_cycNsp, arm_cyc_fe, \
    arm_cyc_loss, arm_cyc_loss_o
from neko_2022_soai_zero.configs.modules.config_bogo_partrec_loss import config_part_recon_loss
from neko_2022_soai_zero.configs.modules.config_recon import config_dcganN, config_dcganN_insnorm, config_masked_l2
