...
from neko_2021_mjt.configs.modules.config_fe_db import config_fe_r45_binorm_orig, config_fe_r45_binorm_ptpt, \
    config_fe_r45_binormBIN_orig, config_fe_r45_binormBIN_ptpt;
...
from neko_2022_soai_zero.configs.modules.soft_cls2 import config_soft_cls_loss2
...
def arm_base_module_setS(srcdst,prefix,maxT,capacity,feat_ch,tr_meta_path,expf=1,fecnt=3,wemb=0.3,wrej=0.1,inplace=True,detached_ta=False,detached_ga_proto=False,dropf=0,dropp=None):
    srcdst=arm_base_fe_module(srcdst,feat_ch,fecnt,prefix,inplace,dropf,expf=expf);
    srcdst=arm_common_part_noloss(srcdst, prefix=prefix, maxT=maxT, capacity=capacity,
                                  feat_ch=feat_ch, tr_meta_path=tr_meta_path, expf=expf,
                                  detached_ta=detached_ta,detached_ga_proto=detached_ga_proto,dropp=dropp);
    srcdst[prefix + "loss_cls_emb"] = config_soft_cls_loss2(wemb,wrej);
